<form method="POST" action="<?= URL ?>coche/show" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <select disabled class="form-control" name="equipo_id" id="">
    ...
    <div class="form-group">
        ...
        <input type="text" disabled value = "<?= $this->coche['marca'] ?>" class="form-control" name="marca" placeholder="" require>
    ...
    <div class="form-group">
        ...
        <input type="text" disabled value = "<?= $this->coche['modelo'] ?>"class="form-control" name="modelo">
    ...
    <div class="form-group">
        ...
        <input type="text" disabled value = "<?= $this->coche['cilindrada'] ?>"class="form-control" name="cilindrada">
